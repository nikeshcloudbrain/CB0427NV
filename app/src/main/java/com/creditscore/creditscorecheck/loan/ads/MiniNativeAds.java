...
public class MiniNativeAds {
    ...
    public FrameLayout getFrameLayout(Activity activity, Dialog dialog) {
        if (dialog != null) {
            return dialog.findViewById(R.id.nativeAdBanner);
        } else {
            return activity.findViewById(R.id.nativeAdBanner);
        }
    }
    ...
    public TextView getTextLayout(Activity activity, Dialog dialog) {
        if (dialog != null) {
            return dialog.findViewById(R.id.ad_space_banner);
        } else {
            return activity.findViewById(R.id.ad_space_banner);
        }
    }
        ...
        if (PowerPreference.getDefaultFile().getBoolean(Constant.AdsOnOff, true)) {
            ...
            if (PowerPreference.getDefaultFile().getBoolean(Constant.GoogleMiniNativeOnOff, true) &&
                ...
                if (PowerPreference.getDefaultFile().getBoolean(Constant.QurekaOnOff, true) && PowerPreference.getDefaultFile().getBoolean(Constant.QurekaMiniNativeOnOff, true)) {
                    ...
                    setQureka(activity, imageViewMain, imageViewBG, imageViewGif, Constant.ADS_TINY);
